  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        if (constraints.maxWidth <= TictactoeBreakpoints.small) {
          return small(context, child);
        }
        else if (constraints.maxWidth <= TictactoeBreakpoints.medium) {
          return (medium ?? large).call(context, child);
        }
        else if (constraints.maxWidth <= TictactoeBreakpoints.large) {
